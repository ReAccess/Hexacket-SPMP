...
namespace test
{
    class QuickLZ
    {
        ...
        [DllImport("quicklz-x64/quicklz150_32_1.dll")] public static extern IntPtr qlz_compress(byte[] source, byte[] destination, IntPtr size, byte[] scratch);
        [DllImport("quicklz-x64/quicklz150_32_1.dll")] public static extern IntPtr qlz_decompress(byte[] source, byte[] destination, byte[] scratch);
        [DllImport("quicklz-x64/quicklz150_32_1.dll")] public static extern IntPtr qlz_size_compressed(byte[] source);
        [DllImport("quicklz-x64/quicklz150_32_1.dll")] public static extern IntPtr qlz_size_decompressed(byte[] source);
        [DllImport("quicklz-x64/quicklz150_32_1.dll")] public static extern int qlz_get_setting(int setting);
